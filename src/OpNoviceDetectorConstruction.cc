...
//
  ...
  G4double efficiency[num]   = {0.8, 1.0};//this makes bubble a detector !!!!
	//still called "Bubble Transportation" in tracking verbose, but my verbose stepping 
	//finds the "Photon detected @ boundary of Bubble"
